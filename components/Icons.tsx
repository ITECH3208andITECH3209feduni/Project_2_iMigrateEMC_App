...
export const UploadIcon: React.FC = () => (
    <svg className="mx-auto h-12 w-12 text-muted/70" stroke="currentColor" fill="none" viewBox="0 0 24 24" aria-hidden="true">
...
export const CalendarIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-5 w-5 text-muted"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const UserIcon: React.FC = () => (
     <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-muted mr-2" viewBox="0 0 20 20" fill="currentColor">
...
export const CogIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-muted mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const EOIIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const UsersIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-8 w-8 text-primary"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
