...
export default function AppointmentScreen() {
  const [activeTab, setActiveTab] = useState<'book' | 'manage'>('manage');
  ...
  const renderTabButton = (tab: 'book' | 'manage', label: string, IconComponent: React.ComponentType<any>, iconProps: any) => (
    <TouchableOpacity
